 ...
 * Generated at: 2018-05-10 01:27:23 UTC
...
if(param=="memberInfo") {
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t/* //새로새성한 li태그 이벤트핸들러 바인딩\r\n");
      out.write("\t\t\t\t\t\t//click : enter와 동일한 효과\r\n");
      out.write("\t\t\t\t\t\t$(\"#autoComplete li\").on(\"click\",function(){\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#searchName\").val($(this).text());\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#autoComplete\").hide().children().remove();\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t//hover\r\n");
      out.write("\t\t\t\t\t\t$(\"#autoComplete li\").hover(function(){\r\n");
