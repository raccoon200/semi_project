 ...
 * Generated at: 2018-05-14 06:06:36 UTC
...
if(param=="adminPage" || param=="adminPageTeam") {
	...
	for(Team t : list){
      ...
      out.write("\tif($(\"[name=introduce]\").val().trim().length==0) {\r\n");
...
for(TeamMember tm : memberList){ 
      ...
      out.write("\t\t\t<input type=\"file\" name=\"up_file\" id=\"\" accept=\".gif, .jpg, .png\" onchange=\"fn_fileUpload(this);\" value=\"");
      out.print(logo!=null?request.getContextPath()+"/images/team/"+logo:"");
      out.write("\"/>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</tr>\r\n");
