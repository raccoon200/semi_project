...
public class NoticeListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pageNo == 1) {
			...
			pageBar += "<a href='"+request.getContextPath()+"/notice/noticeList?cPage="+(pageNo-1)+"'><span class='page gradient'>이전</span></a> ";
		}
...
//				while(pageNo<=pageEnd && pageNo<=totalPage){
		while(!(pageNo>pageEnd || pageNo > totalPage)){
			...
			if(cPage == pageNo ){
				...
				pageBar += "<a href='"+request.getContextPath()+"/notice/noticeList?&cPage="+pageNo+"'>"+"<span class='page gradient'>"+pageNo+"</span>"+"</a> ";
			}
			pageNo++;
		}
		...
		if(pageNo > totalPage){
			...
			pageBar += "<a href='"+request.getContextPath()+"/notice/noticeList?cPage="+pageNo+"'><span class='page gradient'>다음</span></a>";
		}
